 ...
 */
unsigned int sysctl_sched_latency = 60000000ULL;
unsigned int normalized_sysctl_sched_latency = 60000000ULL;
 ...
 * (default: 10msec)
 */
unsigned int __read_mostly sysctl_sched_shares_window = 100000000UL;
 ...
 * default: 5 msec, units: microseconds
  */
unsigned int sysctl_sched_cfs_bandwidth_slice = 50000UL;
#endif
...
unsigned int sysctl_numa_balancing_scan_delay = 5000;
